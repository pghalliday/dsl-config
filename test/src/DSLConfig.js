...
describe('DSLConfig', () => {
  ...
  describe('#load', () => {
    ...
    describe('with a generator callback', () => {
      it('should throw if the callback throws', () => {
        return co(function * () {
          yield dslConfig.load(() => {
            throw new Error('load error');
          });
        }).should.be.rejectedWith('load error');
      });
    });

    describe('with a callback that returns a promise', () => {
      it('should throw if the callback throws', () => {
        return dslConfig.load(() => {
  ...
  describe('#value with a DSLConfig', () => {
    ...
    describe('with a generator callback', () => {
      it('should add a value method', () => {
        return co(function * () {
          const config = yield dslConfig.load(function * (config) {
      ...
      it('should throw if the callback throws', () => {
        return co(function * () {
          yield dslConfig.load(function * (config) {
